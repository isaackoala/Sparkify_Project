...
1. 顾客所听歌曲数目分析
    ![image](https://github.com/isaackoala/Sparkify_Project/blob/master/NumbersOfSongsListened.png )
...
4. 用户生命周期分析
![image](https://gihub.com/isaackoala/Sparkify_Project/blob/master/Life.png)
